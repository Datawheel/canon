...
export default (logic, formatters = {}, variables = {}, locale = envLoc, id = null, setVariables = d => d, openModal = d => d) => {
  ...
  try {
    config = parse({vars: ["variables"], logic}, formatters, locale, setVariables, openModal)(variables);
  }
