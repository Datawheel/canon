export default (status = {}, action) => {
  ...
  switch (action.type) {
    ...
    case "STORY_GENERATOR_NEW":
      return Object.assign({}, status, {dialogOpen: {type: "story_generator", id: action.data.id, force: true}});
    ...
    case "STORY_GENERATOR_UPDATE":
      return Object.assign({}, status, {justUpdated: {type: "story_generator", ...success}});
    case "STORY_MATERIALIZER_NEW":
      return Object.assign({}, status, {dialogOpen: {type: "story_materializer", id: action.data.id, force: true}});
    case "STORY_MATERIALIZER_DUPLICATE":
      return Object.assign({}, status, {dialogOpen: {type: "story_materializer", id: action.data.id, force: true}});
    case "STORY_MATERIALIZER_UPDATE":
      return Object.assign({}, status, {justUpdated: {type: "story_materializer", ...success}});
    case "STORY_SELECTOR_NEW":
      return Object.assign({}, status, {dialogOpen: {type: "story_selector", id: action.data.id, force: true}});
    case "STORY_SELECTOR_DUPLICATE":
      return Object.assign({}, status, {dialogOpen: {type: "story_selector", id: action.data.id, force: true}});
    case "STORY_SELECTOR_UPDATE":
      return Object.assign({}, status, {dialogOpen: false, justUpdated: {type: "story_selector", ...success}});
    ...
    case "STORY_GENERATOR_DELETE":
      return Object.assign({}, status, {
        justDeleted: {type: "story_generator", id: action.data.id, parent_id: action.data.parent_id},
        dialogOpen: false
      });
    case "STORY_MATERIALIZER_DELETE":
      return Object.assign({}, status, {
        justDeleted: {type: "story_materializer", id: action.data.id, parent_id: action.data.parent_id},
        dialogOpen: false
      });
    case "STORY_DELETE":
    ...
    case "STORY_GENERATOR_ERROR":
      return Object.assign({}, status, {justUpdated: {type: "story_generator", ...error}});
    case "STORY_MATERIALIZER_ERROR":
      return Object.assign({}, status, {justUpdated: {type: "story_materializer", ...error}});
    ...
    case "STORY_SELECTOR_ERROR":
      return Object.assign({}, status, {justUpdated: {type: "story_selector", ...error}});
